...
$pdf->Cell(25, 10, 'Receptor', 1, 0, 'C', 1);
$pdf->Cell(25, 10, 'Emisor', 1, 1, 'C', 1);

$pdf->setFont('Arial', '', 8);
$num = 1;

foreach ($topFacturas as $f) {
    $receptor = $f['receptorNit'] . " " . $f['receptorRazonSocial'];
    $emisor = $f['emisorNit'] . " " . $f['emisorRazonSocial'];
    ...
    $pdf->Cell(25, 10, $receptor, 1, 0, 'C', 0);
    $pdf->Cell(25, 10, $emisor, 1, 1, 'C', 0);
    $num++;
}
